          ...
          <div key={workshop.id}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {workshop.images.map((image, index) => (
                <div key={index} className="group relative cursor-pointer overflow-hidden rounded-lg shadow-md transition-transform duration-200 active:scale-95" onClick={() => openModal(image)}>
